...
//oppgave 5 og oppgave 6
void MainWindow::on_Modetoggle_toggled(bool checked)
{
    if(checked)
    {
        mRenderWindow->mToggle = true;
        ui->Modetoggle->setText("editor mode");
    }
    else
    {
        mRenderWindow->mToggle = false;
        ui->Modetoggle->setText("play mode");
    }
}

void MainWindow::on_Reset_toggled(bool checked)
{
    if(checked)
    {
        mRenderWindow->reset = true;
    }
    else
    {
        mRenderWindow->reset = false;
    }
}
